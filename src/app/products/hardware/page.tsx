...
const HardwarePage = () => {
  const hardwareCategories = [
    ...
    },
    {
      ...
      description:
        "High-security mortise lock handles for premium door applications",
      features: [
        "High Security",
    ...
    },
    {
      ...
      description:
        "Stylish and functional handles for wardrobe and closet doors",
      features: [
        "Ergonomic Design",
        "Multiple Finishes",
        "Easy Installation",
    ...
    },
    {
      name: "Kitchen Handle",
      description:
        "Modern kitchen cabinet and drawer handles for contemporary kitchens",
      features: [
        "Food Safe Finish",
        "Easy to Clean",
        "Stylish Design",
    ...
    },
    {
      name: "Tendom Box",
      description:
        "Premium drawer systems with smooth operation and durability",
      features: [
        "Smooth Operation",
        "High Load Capacity",
        "Self-Closing",
    ...
    },
    {
      ...
      description:
        "Complete range of furniture accessories for all applications",
      features: [
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xl text-primary-foreground/90 leading-relaxed">
                    Complete range of furniture hardware, hinges, handles, and
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Professional-grade hardware solutions for furniture, cabinets,
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Premium quality hardware backed by extensive testing and
              ...
              {[
                {
                  ...
                  desc: "Precision engineering from leading manufacturers",
                },
                {
                  title: "Load Tested",
                  desc: "Rigorous testing for maximum durability",
                },
                {
                  title: "Easy Installation",
                  desc: "Simple mounting with detailed instructions",
                },
                {
                  title: "5 Year Warranty",
                  desc: "Comprehensive warranty on all products",
                },
              ].map((feature) => (
                <div
                  key={feature.title}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center max-w-7xl">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-3xl font-serif font-bold mb-4">
                Need Hardware Consultation?
              </h2>
              <p className="text-muted-foreground mb-8">
                Our technical experts can help you select the right hardware for
